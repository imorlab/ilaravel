            ...
            <tr>
                <td valign="middle" width="50%">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                            <td width="300" align="{{ $block['content']['left']['button_alignment'] ?? 'center' }}" style="font-weight: bold; text-align: {{ $block['content']['left']['button_alignment'] ?? 'center' }}; font-family: sans-serif; font-size: 12px; line-height: 20px; color: #000000; padding: 20px; background-color: #fafafa; margin: 0;" class="darkmode-bg">
                                <table cellspacing="0" cellpadding="0" border="0" width="300" align="{{ $block['content']['left']['button_alignment'] ?? 'center' }}">
                                    <tr>
